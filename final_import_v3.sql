...
IF NOT EXISTS (SELECT 1 FROM ProductVariantAttributeValue WHERE ProductVariantId = @Vid AND ValueId = @Valid) INSERT INTO ProductVariantAttributeValue (ProductVariantId, ValueId) VALUES (@Vid, @Valid);
INSERT INTO ProductVariants (ProductId, SKU, VariantName, Price, CostPrice, StockQuantity, ImageUrl, CreatedDate)
VALUES (@Pid, N'MAL-BỘ 2-15G', N'15g', 3452128.0, 2761702.4000000004, 5, N'https://motobatt.com/image/cache/product_2.jpg', GETDATE());
SET @Vid = SCOPE_IDENTITY();
IF NOT EXISTS (SELECT 1 FROM ProductAttributes WHERE AttributeName = N'Trọng lượng') INSERT INTO ProductAttributes (AttributeName) VALUES (N'Trọng lượng');
SET @Aid = (SELECT AttributeId FROM ProductAttributes WHERE AttributeName = N'Trọng lượng');
IF NOT EXISTS (SELECT 1 FROM AttributeValues WHERE AttributeId = @Aid AND Value = N'15g') INSERT INTO AttributeValues (AttributeId, Value) VALUES (@Aid, N'15g');
...
INSERT INTO ProductVariants (ProductId, SKU, VariantName, Price, CostPrice, StockQuantity, ImageUrl, CreatedDate)
VALUES (@Pid, N'API-BỘ 3-9G', N'9g', 549951.0, 439960.80000000005, 40, N'https://malossistore.vn/img/p/product_3.jpg', GETDATE());
SET @Vid = SCOPE_IDENTITY();
IF NOT EXISTS (SELECT 1 FROM ProductAttributes WHERE AttributeName = N'Trọng lượng') INSERT INTO ProductAttributes (AttributeName) VALUES (N'Trọng lượng');
SET @Aid = (SELECT AttributeId FROM ProductAttributes WHERE AttributeName = N'Trọng lượng');
IF NOT EXISTS (SELECT 1 FROM AttributeValues WHERE AttributeId = @Aid AND Value = N'9g') INSERT INTO AttributeValues (AttributeId, Value) VALUES (@Aid, N'9g');
...
IF NOT EXISTS (SELECT 1 FROM ProductVariantAttributeValue WHERE ProductVariantId = @Vid AND ValueId = @Valid) INSERT INTO ProductVariantAttributeValue (ProductVariantId, ValueId) VALUES (@Vid, @Valid);
INSERT INTO ProductVariants (ProductId, SKU, VariantName, Price, CostPrice, StockQuantity, ImageUrl, CreatedDate)
VALUES (@Pid, N'API-BỘ 3-15G', N'15g', 538867.0, 431093.60000000003, 43, N'https://malossistore.vn/img/p/product_3.jpg', GETDATE());
SET @Vid = SCOPE_IDENTITY();
IF NOT EXISTS (SELECT 1 FROM ProductAttributes WHERE AttributeName = N'Trọng lượng') INSERT INTO ProductAttributes (AttributeName) VALUES (N'Trọng lượng');
SET @Aid = (SELECT AttributeId FROM ProductAttributes WHERE AttributeName = N'Trọng lượng');
IF NOT EXISTS (SELECT 1 FROM AttributeValues WHERE AttributeId = @Aid AND Value = N'15g') INSERT INTO AttributeValues (AttributeId, Value) VALUES (@Aid, N'15g');
...
INSERT INTO ProductVariants (ProductId, SKU, VariantName, Price, CostPrice, StockQuantity, ImageUrl, CreatedDate)
VALUES (@Pid, N'FAI-BỘ 4-9G', N'9g', 3278868.0, 2623094.4000000004, 31, N'https://malossistore.vn/img/p/product_4.jpg', GETDATE());
SET @Vid = SCOPE_IDENTITY();
IF NOT EXISTS (SELECT 1 FROM ProductAttributes WHERE AttributeName = N'Trọng lượng') INSERT INTO ProductAttributes (AttributeName) VALUES (N'Trọng lượng');
SET @Aid = (SELECT AttributeId FROM ProductAttributes WHERE AttributeName = N'Trọng lượng');
IF NOT EXISTS (SELECT 1 FROM AttributeValues WHERE AttributeId = @Aid AND Value = N'9g') INSERT INTO AttributeValues (AttributeId, Value) VALUES (@Aid, N'9g');
...
IF NOT EXISTS (SELECT 1 FROM ProductVariantAttributeValue WHERE ProductVariantId = @Vid AND ValueId = @Valid) INSERT INTO ProductVariantAttributeValue (ProductVariantId, ValueId) VALUES (@Vid, @Valid);
INSERT INTO ProductVariants (ProductId, SKU, VariantName, Price, CostPrice, StockQuantity, ImageUrl, CreatedDate)
VALUES (@Pid, N'FAI-BỘ 4-13G', N'13g', 3286621.0, 2629296.8000000003, 32, N'https://malossistore.vn/img/p/product_4.jpg', GETDATE());
SET @Vid = SCOPE_IDENTITY();
IF NOT EXISTS (SELECT 1 FROM ProductAttributes WHERE AttributeName = N'Trọng lượng') INSERT INTO ProductAttributes (AttributeName) VALUES (N'Trọng lượng');
SET @Aid = (SELECT AttributeId FROM ProductAttributes WHERE AttributeName = N'Trọng lượng');
IF NOT EXISTS (SELECT 1 FROM AttributeValues WHERE AttributeId = @Aid AND Value = N'13g') INSERT INTO AttributeValues (AttributeId, Value) VALUES (@Aid, N'13g');
...
INSERT INTO ProductVariants (ProductId, SKU, VariantName, Price, CostPrice, StockQuantity, ImageUrl, CreatedDate)
VALUES (@Pid, N'API-BỘ 5-9G', N'9g', 3410548.0, 2728438.4000000004, 16, N'https://malossistore.vn/img/p/product_5.jpg', GETDATE());
SET @Vid = SCOPE_IDENTITY();
IF NOT EXISTS (SELECT 1 FROM ProductAttributes WHERE AttributeName = N'Trọng lượng') INSERT INTO ProductAttributes (AttributeName) VALUES (N'Trọng lượng');
SET @Aid = (SELECT AttributeId FROM ProductAttributes WHERE AttributeName = N'Trọng lượng');
IF NOT EXISTS (SELECT 1 FROM AttributeValues WHERE AttributeId = @Aid AND Value = N'9g') INSERT INTO AttributeValues (AttributeId, Value) VALUES (@Aid, N'9g');
...
INSERT INTO ProductVariants (ProductId, SKU, VariantName, Price, CostPrice, StockQuantity, ImageUrl, CreatedDate)
VALUES (@Pid, N'MTX-BỘ 6-42T', N'42T', 2317278.0, 1853822.4000000001, 10, N'https://motobatt.com/image/cache/product_6.jpg', GETDATE());
SET @Vid = SCOPE_IDENTITY();
...
IF NOT EXISTS (SELECT 1 FROM ProductVariantAttributeValue WHERE ProductVariantId = @Vid AND ValueId = @Valid) INSERT INTO ProductVariantAttributeValue (ProductVariantId, ValueId) VALUES (@Vid, @Valid);
INSERT INTO ProductVariants (ProductId, SKU, VariantName, Price, CostPrice, StockQuantity, ImageUrl, CreatedDate)
VALUES (@Pid, N'MTX-BỘ 6-44T', N'44T', 2357933.0, 1886346.4000000001, 13, N'https://motobatt.com/image/cache/product_6.jpg', GETDATE());
SET @Vid = SCOPE_IDENTITY();
IF NOT EXISTS (SELECT 1 FROM ProductAttributes WHERE AttributeName = N'Thông số') INSERT INTO ProductAttributes (AttributeName) VALUES (N'Thông số');
SET @Aid = (SELECT AttributeId FROM ProductAttributes WHERE AttributeName = N'Thông số');
...
IF NOT EXISTS (SELECT 1 FROM ProductVariantAttributeValue WHERE ProductVariantId = @Vid AND ValueId = @Valid) INSERT INTO ProductVariantAttributeValue (ProductVariantId, ValueId) VALUES (@Vid, @Valid);
INSERT INTO ProductVariants (ProductId, SKU, VariantName, Price, CostPrice, StockQuantity, ImageUrl, CreatedDate)
VALUES (@Pid, N'MTX-BỘ 6-45T', N'45T', 2303259.0, 1842607.2000000002, 21, N'https://motobatt.com/image/cache/product_6.jpg', GETDATE());
SET @Vid = SCOPE_IDENTITY();
IF NOT EXISTS (SELECT 1 FROM ProductAttributes WHERE AttributeName = N'Thông số') INSERT INTO ProductAttributes (AttributeName) VALUES (N'Thông số');
SET @Aid = (SELECT AttributeId FROM ProductAttributes WHERE AttributeName = N'Thông số');
...
IF NOT EXISTS (SELECT 1 FROM ProductVariantAttributeValue WHERE ProductVariantId = @Vid AND ValueId = @Valid) INSERT INTO ProductVariantAttributeValue (ProductVariantId, ValueId) VALUES (@Vid, @Valid);
INSERT INTO ProductVariants (ProductId, SKU, VariantName, Price, CostPrice, StockQuantity, ImageUrl, CreatedDate)
VALUES (@Pid, N'API-BỘ 7-44T', N'44T', 2446309.0, 1957047.2000000002, 15, N'https://faito.com.vn/wp-content/uploads/product_7.jpg', GETDATE());
SET @Vid = SCOPE_IDENTITY();
IF NOT EXISTS (SELECT 1 FROM ProductAttributes WHERE AttributeName = N'Thông số') INSERT INTO ProductAttributes (AttributeName) VALUES (N'Thông số');
SET @Aid = (SELECT AttributeId FROM ProductAttributes WHERE AttributeName = N'Thông số');
IF NOT EXISTS (SELECT 1 FROM AttributeValues WHERE AttributeId = @Aid AND Value = N'44T') INSERT INTO AttributeValues (AttributeId, Value) VALUES (@Aid, N'44T');
...
INSERT INTO ProductVariants (ProductId, SKU, VariantName, Price, CostPrice, StockQuantity, ImageUrl, CreatedDate)
VALUES (@Pid, N'MTX-BỘ 8-42T', N'42T', 3340788.0, 2672630.4000000004, 16, N'https://faito.com.vn/wp-content/uploads/product_8.jpg', GETDATE());
SET @Vid = SCOPE_IDENTITY();
IF NOT EXISTS (SELECT 1 FROM ProductAttributes WHERE AttributeName = N'Thông số') INSERT INTO ProductAttributes (AttributeName) VALUES (N'Thông số');
SET @Aid = (SELECT AttributeId FROM ProductAttributes WHERE AttributeName = N'Thông số');
IF NOT EXISTS (SELECT 1 FROM AttributeValues WHERE AttributeId = @Aid AND Value = N'42T') INSERT INTO AttributeValues (AttributeId, Value) VALUES (@Aid, N'42T');
...
IF NOT EXISTS (SELECT 1 FROM ProductVariantAttributeValue WHERE ProductVariantId = @Vid AND ValueId = @Valid) INSERT INTO ProductVariantAttributeValue (ProductVariantId, ValueId) VALUES (@Vid, @Valid);
INSERT INTO ProductVariants (ProductId, SKU, VariantName, Price, CostPrice, StockQuantity, ImageUrl, CreatedDate)
VALUES (@Pid, N'MTX-BỘ 8-45T', N'45T', 3301008.0, 2640806.4000000004, 49, N'https://faito.com.vn/wp-content/uploads/product_8.jpg', GETDATE());
SET @Vid = SCOPE_IDENTITY();
IF NOT EXISTS (SELECT 1 FROM ProductAttributes WHERE AttributeName = N'Thông số') INSERT INTO ProductAttributes (AttributeName) VALUES (N'Thông số');
SET @Aid = (SELECT AttributeId FROM ProductAttributes WHERE AttributeName = N'Thông số');
IF NOT EXISTS (SELECT 1 FROM AttributeValues WHERE AttributeId = @Aid AND Value = N'45T') INSERT INTO AttributeValues (AttributeId, Value) VALUES (@Aid, N'45T');
...
IF NOT EXISTS (SELECT 1 FROM ProductVariantAttributeValue WHERE ProductVariantId = @Vid AND ValueId = @Valid) INSERT INTO ProductVariantAttributeValue (ProductVariantId, ValueId) VALUES (@Vid, @Valid);
INSERT INTO ProductVariants (ProductId, SKU, VariantName, Price, CostPrice, StockQuantity, ImageUrl, CreatedDate)
VALUES (@Pid, N'RGV-BỘ 9-43T', N'43T', 3517586.0, 2814068.8000000003, 43, N'https://malossistore.vn/img/p/product_9.jpg', GETDATE());
SET @Vid = SCOPE_IDENTITY();
IF NOT EXISTS (SELECT 1 FROM ProductAttributes WHERE AttributeName = N'Thông số') INSERT INTO ProductAttributes (AttributeName) VALUES (N'Thông số');
SET @Aid = (SELECT AttributeId FROM ProductAttributes WHERE AttributeName = N'Thông số');
IF NOT EXISTS (SELECT 1 FROM AttributeValues WHERE AttributeId = @Aid AND Value = N'43T') INSERT INTO AttributeValues (AttributeId, Value) VALUES (@Aid, N'43T');
...
IF NOT EXISTS (SELECT 1 FROM ProductVariantAttributeValue WHERE ProductVariantId = @Vid AND ValueId = @Valid) INSERT INTO ProductVariantAttributeValue (ProductVariantId, ValueId) VALUES (@Vid, @Valid);
INSERT INTO ProductVariants (ProductId, SKU, VariantName, Price, CostPrice, StockQuantity, ImageUrl, CreatedDate)
VALUES (@Pid, N'YAG-CĂM11-10X184', N'10x184', 2287038.0, 1829630.4000000001, 42, N'https://faito.com.vn/wp-content/uploads/product_11.jpg', GETDATE());
SET @Vid = SCOPE_IDENTITY();
IF NOT EXISTS (SELECT 1 FROM ProductAttributes WHERE AttributeName = N'Kích thước') INSERT INTO ProductAttributes (AttributeName) VALUES (N'Kích thước');
SET @Aid = (SELECT AttributeId FROM ProductAttributes WHERE AttributeName = N'Kích thước');
...
IF NOT EXISTS (SELECT 1 FROM ProductVariantAttributeValue WHERE ProductVariantId = @Vid AND ValueId = @Valid) INSERT INTO ProductVariantAttributeValue (ProductVariantId, ValueId) VALUES (@Vid, @Valid);
INSERT INTO ProductVariants (ProductId, SKU, VariantName, Price, CostPrice, StockQuantity, ImageUrl, CreatedDate)
VALUES (@Pid, N'RGV-CĂM14-10X157', N'10x157', 2593379.0, 2074703.2000000002, 36, N'https://motobatt.com/image/cache/product_14.jpg', GETDATE());
SET @Vid = SCOPE_IDENTITY();
IF NOT EXISTS (SELECT 1 FROM ProductAttributes WHERE AttributeName = N'Kích thước') INSERT INTO ProductAttributes (AttributeName) VALUES (N'Kích thước');
SET @Aid = (SELECT AttributeId FROM ProductAttributes WHERE AttributeName = N'Kích thước');
IF NOT EXISTS (SELECT 1 FROM AttributeValues WHERE AttributeId = @Aid AND Value = N'10x157') INSERT INTO AttributeValues (AttributeId, Value) VALUES (@Aid, N'10x157');
...
INSERT INTO ProductVariants (ProductId, SKU, VariantName, Price, CostPrice, StockQuantity, ImageUrl, CreatedDate)
VALUES (@Pid, N'TAN-CĂM15-9X157', N'9x157', 969869.0, 775895.2000000001, 18, N'https://malossistore.vn/img/p/product_15.jpg', GETDATE());
SET @Vid = SCOPE_IDENTITY();
IF NOT EXISTS (SELECT 1 FROM ProductAttributes WHERE AttributeName = N'Kích thước') INSERT INTO ProductAttributes (AttributeName) VALUES (N'Kích thước');
SET @Aid = (SELECT AttributeId FROM ProductAttributes WHERE AttributeName = N'Kích thước');
IF NOT EXISTS (SELECT 1 FROM AttributeValues WHERE AttributeId = @Aid AND Value = N'9x157') INSERT INTO AttributeValues (AttributeId, Value) VALUES (@Aid, N'9x157');
...
IF NOT EXISTS (SELECT 1 FROM ProductVariantAttributeValue WHERE ProductVariantId = @Vid AND ValueId = @Valid) INSERT INTO ProductVariantAttributeValue (ProductVariantId, ValueId) VALUES (@Vid, @Valid);
INSERT INTO ProductVariants (ProductId, SKU, VariantName, Price, CostPrice, StockQuantity, ImageUrl, CreatedDate)
VALUES (@Pid, N'TAN-CĂM15-9X184', N'9x184', 907867.0, 726293.6000000001, 27, N'https://malossistore.vn/img/p/product_15.jpg', GETDATE());
SET @Vid = SCOPE_IDENTITY();
IF NOT EXISTS (SELECT 1 FROM ProductAttributes WHERE AttributeName = N'Kích thước') INSERT INTO ProductAttributes (AttributeName) VALUES (N'Kích thước');
SET @Aid = (SELECT AttributeId FROM ProductAttributes WHERE AttributeName = N'Kích thước');
IF NOT EXISTS (SELECT 1 FROM AttributeValues WHERE AttributeId = @Aid AND Value = N'9x184') INSERT INTO AttributeValues (AttributeId, Value) VALUES (@Aid, N'9x184');
...
IF NOT EXISTS (SELECT 1 FROM ProductVariantAttributeValue WHERE ProductVariantId = @Vid AND ValueId = @Valid) INSERT INTO ProductVariantAttributeValue (ProductVariantId, ValueId) VALUES (@Vid, @Valid);
INSERT INTO ProductVariants (ProductId, SKU, VariantName, Price, CostPrice, StockQuantity, ImageUrl, CreatedDate)
VALUES (@Pid, N'TAN-CĂM15-10X184', N'10x184', 944682.0, 755745.6000000001, 10, N'https://malossistore.vn/img/p/product_15.jpg', GETDATE());
SET @Vid = SCOPE_IDENTITY();
IF NOT EXISTS (SELECT 1 FROM ProductAttributes WHERE AttributeName = N'Kích thước') INSERT INTO ProductAttributes (AttributeName) VALUES (N'Kích thước');
SET @Aid = (SELECT AttributeId FROM ProductAttributes WHERE AttributeName = N'Kích thước');
IF NOT EXISTS (SELECT 1 FROM AttributeValues WHERE AttributeId = @Aid AND Value = N'10x184') INSERT INTO AttributeValues (AttributeId, Value) VALUES (@Aid, N'10x184');
...
INSERT INTO ProductVariants (ProductId, SKU, VariantName, Price, CostPrice, StockQuantity, ImageUrl, CreatedDate)
VALUES (@Pid, N'SEN-BÌN16-5AH', N'5Ah', 1838098.0, 1470478.4000000001, 42, N'https://faito.com.vn/wp-content/uploads/product_16.jpg', GETDATE());
SET @Vid = SCOPE_IDENTITY();
...
IF NOT EXISTS (SELECT 1 FROM ProductVariantAttributeValue WHERE ProductVariantId = @Vid AND ValueId = @Valid) INSERT INTO ProductVariantAttributeValue (ProductVariantId, ValueId) VALUES (@Vid, @Valid);
INSERT INTO ProductVariants (ProductId, SKU, VariantName, Price, CostPrice, StockQuantity, ImageUrl, CreatedDate)
VALUES (@Pid, N'SEN-BÌN16-6AH', N'6Ah', 1831553.0, 1465242.4000000001, 11, N'https://faito.com.vn/wp-content/uploads/product_16.jpg', GETDATE());
SET @Vid = SCOPE_IDENTITY();
IF NOT EXISTS (SELECT 1 FROM ProductAttributes WHERE AttributeName = N'Dung lượng') INSERT INTO ProductAttributes (AttributeName) VALUES (N'Dung lượng');
SET @Aid = (SELECT AttributeId FROM ProductAttributes WHERE AttributeName = N'Dung lượng');
...
INSERT INTO ProductVariants (ProductId, SKU, VariantName, Price, CostPrice, StockQuantity, ImageUrl, CreatedDate)
VALUES (@Pid, N'MOT-BÌN17-5AH', N'5Ah', 285893.0, 228714.40000000002, 11, N'https://motobatt.com/image/cache/product_17.jpg', GETDATE());
SET @Vid = SCOPE_IDENTITY();
IF NOT EXISTS (SELECT 1 FROM ProductAttributes WHERE AttributeName = N'Dung lượng') INSERT INTO ProductAttributes (AttributeName) VALUES (N'Dung lượng');
SET @Aid = (SELECT AttributeId FROM ProductAttributes WHERE AttributeName = N'Dung lượng');
IF NOT EXISTS (SELECT 1 FROM AttributeValues WHERE AttributeId = @Aid AND Value = N'5Ah') INSERT INTO AttributeValues (AttributeId, Value) VALUES (@Aid, N'5Ah');
...
IF NOT EXISTS (SELECT 1 FROM ProductVariantAttributeValue WHERE ProductVariantId = @Vid AND ValueId = @Valid) INSERT INTO ProductVariantAttributeValue (ProductVariantId, ValueId) VALUES (@Vid, @Valid);
INSERT INTO ProductVariants (ProductId, SKU, VariantName, Price, CostPrice, StockQuantity, ImageUrl, CreatedDate)
VALUES (@Pid, N'MOT-BÌN18-7AH', N'7Ah', 3144781.0, 2515824.8000000003, 23, N'https://malossistore.vn/img/p/product_18.jpg', GETDATE());
SET @Vid = SCOPE_IDENTITY();
IF NOT EXISTS (SELECT 1 FROM ProductAttributes WHERE AttributeName = N'Dung lượng') INSERT INTO ProductAttributes (AttributeName) VALUES (N'Dung lượng');
SET @Aid = (SELECT AttributeId FROM ProductAttributes WHERE AttributeName = N'Dung lượng');
IF NOT EXISTS (SELECT 1 FROM AttributeValues WHERE AttributeId = @Aid AND Value = N'7Ah') INSERT INTO AttributeValues (AttributeId, Value) VALUES (@Aid, N'7Ah');
...
IF NOT EXISTS (SELECT 1 FROM ProductVariantAttributeValue WHERE ProductVariantId = @Vid AND ValueId = @Valid) INSERT INTO ProductVariantAttributeValue (ProductVariantId, ValueId) VALUES (@Vid, @Valid);
INSERT INTO ProductVariants (ProductId, SKU, VariantName, Price, CostPrice, StockQuantity, ImageUrl, CreatedDate)
VALUES (@Pid, N'MOT-BÌN19-6AH', N'6Ah', 2798786.0, 2239028.8000000003, 28, N'https://faito.com.vn/wp-content/uploads/product_19.jpg', GETDATE());
SET @Vid = SCOPE_IDENTITY();
IF NOT EXISTS (SELECT 1 FROM ProductAttributes WHERE AttributeName = N'Dung lượng') INSERT INTO ProductAttributes (AttributeName) VALUES (N'Dung lượng');
SET @Aid = (SELECT AttributeId FROM ProductAttributes WHERE AttributeName = N'Dung lượng');
IF NOT EXISTS (SELECT 1 FROM AttributeValues WHERE AttributeId = @Aid AND Value = N'6Ah') INSERT INTO AttributeValues (AttributeId, Value) VALUES (@Aid, N'6Ah');
...
IF NOT EXISTS (SELECT 1 FROM ProductVariantAttributeValue WHERE ProductVariantId = @Vid AND ValueId = @Valid) INSERT INTO ProductVariantAttributeValue (ProductVariantId, ValueId) VALUES (@Vid, @Valid);
INSERT INTO ProductVariants (ProductId, SKU, VariantName, Price, CostPrice, StockQuantity, ImageUrl, CreatedDate)
VALUES (@Pid, N'MOT-BÌN19-9AH', N'9Ah', 2807121.0, 2245696.8000000003, 12, N'https://faito.com.vn/wp-content/uploads/product_19.jpg', GETDATE());
SET @Vid = SCOPE_IDENTITY();
IF NOT EXISTS (SELECT 1 FROM ProductAttributes WHERE AttributeName = N'Dung lượng') INSERT INTO ProductAttributes (AttributeName) VALUES (N'Dung lượng');
SET @Aid = (SELECT AttributeId FROM ProductAttributes WHERE AttributeName = N'Dung lượng');
IF NOT EXISTS (SELECT 1 FROM AttributeValues WHERE AttributeId = @Aid AND Value = N'9Ah') INSERT INTO AttributeValues (AttributeId, Value) VALUES (@Aid, N'9Ah');
...
IF NOT EXISTS (SELECT 1 FROM ProductVariantAttributeValue WHERE ProductVariantId = @Vid AND ValueId = @Valid) INSERT INTO ProductVariantAttributeValue (ProductVariantId, ValueId) VALUES (@Vid, @Valid);
INSERT INTO ProductVariants (ProductId, SKU, VariantName, Price, CostPrice, StockQuantity, ImageUrl, CreatedDate)
VALUES (@Pid, N'SEN-BÌN20-6AH', N'6Ah', 522126.0, 417700.80000000005, 45, N'https://motobatt.com/image/cache/product_20.jpg', GETDATE());
SET @Vid = SCOPE_IDENTITY();
IF NOT EXISTS (SELECT 1 FROM ProductAttributes WHERE AttributeName = N'Dung lượng') INSERT INTO ProductAttributes (AttributeName) VALUES (N'Dung lượng');
SET @Aid = (SELECT AttributeId FROM ProductAttributes WHERE AttributeName = N'Dung lượng');
IF NOT EXISTS (SELECT 1 FROM AttributeValues WHERE AttributeId = @Aid AND Value = N'6Ah') INSERT INTO AttributeValues (AttributeId, Value) VALUES (@Aid, N'6Ah');
...
IF NOT EXISTS (SELECT 1 FROM ProductVariantAttributeValue WHERE ProductVariantId = @Vid AND ValueId = @Valid) INSERT INTO ProductVariantAttributeValue (ProductVariantId, ValueId) VALUES (@Vid, @Valid);
INSERT INTO ProductVariants (ProductId, SKU, VariantName, Price, CostPrice, StockQuantity, ImageUrl, CreatedDate)
VALUES (@Pid, N'SEN-BÌN20-7AH', N'7Ah', 506932.0, 405545.60000000003, 7, N'https://motobatt.com/image/cache/product_20.jpg', GETDATE());
SET @Vid = SCOPE_IDENTITY();
IF NOT EXISTS (SELECT 1 FROM ProductAttributes WHERE AttributeName = N'Dung lượng') INSERT INTO ProductAttributes (AttributeName) VALUES (N'Dung lượng');
SET @Aid = (SELECT AttributeId FROM ProductAttributes WHERE AttributeName = N'Dung lượng');
IF NOT EXISTS (SELECT 1 FROM AttributeValues WHERE AttributeId = @Aid AND Value = N'7Ah') INSERT INTO AttributeValues (AttributeId, Value) VALUES (@Aid, N'7Ah');
...
IF NOT EXISTS (SELECT 1 FROM ProductVariantAttributeValue WHERE ProductVariantId = @Vid AND ValueId = @Valid) INSERT INTO ProductVariantAttributeValue (ProductVariantId, ValueId) VALUES (@Vid, @Valid);
INSERT INTO ProductVariants (ProductId, SKU, VariantName, Price, CostPrice, StockQuantity, ImageUrl, CreatedDate)
VALUES (@Pid, N'SEN-BÌN20-9AH', N'9Ah', 481247.0, 384997.60000000003, 36, N'https://motobatt.com/image/cache/product_20.jpg', GETDATE());
SET @Vid = SCOPE_IDENTITY();
IF NOT EXISTS (SELECT 1 FROM ProductAttributes WHERE AttributeName = N'Dung lượng') INSERT INTO ProductAttributes (AttributeName) VALUES (N'Dung lượng');
SET @Aid = (SELECT AttributeId FROM ProductAttributes WHERE AttributeName = N'Dung lượng');
IF NOT EXISTS (SELECT 1 FROM AttributeValues WHERE AttributeId = @Aid AND Value = N'9Ah') INSERT INTO AttributeValues (AttributeId, Value) VALUES (@Aid, N'9Ah');
...
INSERT INTO ProductVariants (ProductId, SKU, VariantName, Price, CostPrice, StockQuantity, ImageUrl, CreatedDate)
VALUES (@Pid, N'MAL-LỌC21-VARIO/CLICK', N'Vario/Click', 1419303.0, 1135442.4000000001, 36, N'https://faito.com.vn/wp-content/uploads/product_21.jpg', GETDATE());
SET @Vid = SCOPE_IDENTITY();
...
IF NOT EXISTS (SELECT 1 FROM ProductVariantAttributeValue WHERE ProductVariantId = @Vid AND ValueId = @Valid) INSERT INTO ProductVariantAttributeValue (ProductVariantId, ValueId) VALUES (@Vid, @Valid);
INSERT INTO ProductVariants (ProductId, SKU, VariantName, Price, CostPrice, StockQuantity, ImageUrl, CreatedDate)
VALUES (@Pid, N'MAL-LỌC21-AIRBLADE', N'Airblade', 1433298.0, 1146638.4000000001, 38, N'https://faito.com.vn/wp-content/uploads/product_21.jpg', GETDATE());
SET @Vid = SCOPE_IDENTITY();
IF NOT EXISTS (SELECT 1 FROM ProductAttributes WHERE AttributeName = N'Loại xe') INSERT INTO ProductAttributes (AttributeName) VALUES (N'Loại xe');
SET @Aid = (SELECT AttributeId FROM ProductAttributes WHERE AttributeName = N'Loại xe');
...
INSERT INTO ProductVariants (ProductId, SKU, VariantName, Price, CostPrice, StockQuantity, ImageUrl, CreatedDate)
VALUES (@Pid, N'KOZ-LỌC22-VARIO/CLICK', N'Vario/Click', 2558248.0, 2046598.4000000001, 31, N'https://faito.com.vn/wp-content/uploads/product_22.jpg', GETDATE());
SET @Vid = SCOPE_IDENTITY();
IF NOT EXISTS (SELECT 1 FROM ProductAttributes WHERE AttributeName = N'Loại xe') INSERT INTO ProductAttributes (AttributeName) VALUES (N'Loại xe');
SET @Aid = (SELECT AttributeId FROM ProductAttributes WHERE AttributeName = N'Loại xe');
IF NOT EXISTS (SELECT 1 FROM AttributeValues WHERE AttributeId = @Aid AND Value = N'Vario/Click') INSERT INTO AttributeValues (AttributeId, Value) VALUES (@Aid, N'Vario/Click');
...
IF NOT EXISTS (SELECT 1 FROM ProductVariantAttributeValue WHERE ProductVariantId = @Vid AND ValueId = @Valid) INSERT INTO ProductVariantAttributeValue (ProductVariantId, ValueId) VALUES (@Vid, @Valid);
INSERT INTO ProductVariants (ProductId, SKU, VariantName, Price, CostPrice, StockQuantity, ImageUrl, CreatedDate)
VALUES (@Pid, N'KOZ-LỌC22-AIRBLADE', N'Airblade', 2584468.0, 2067574.4000000001, 38, N'https://faito.com.vn/wp-content/uploads/product_22.jpg', GETDATE());
SET @Vid = SCOPE_IDENTITY();
IF NOT EXISTS (SELECT 1 FROM ProductAttributes WHERE AttributeName = N'Loại xe') INSERT INTO ProductAttributes (AttributeName) VALUES (N'Loại xe');
SET @Aid = (SELECT AttributeId FROM ProductAttributes WHERE AttributeName = N'Loại xe');
IF NOT EXISTS (SELECT 1 FROM AttributeValues WHERE AttributeId = @Aid AND Value = N'Airblade') INSERT INTO AttributeValues (AttributeId, Value) VALUES (@Aid, N'Airblade');
...
IF NOT EXISTS (SELECT 1 FROM ProductVariantAttributeValue WHERE ProductVariantId = @Vid AND ValueId = @Valid) INSERT INTO ProductVariantAttributeValue (ProductVariantId, ValueId) VALUES (@Vid, @Valid);
INSERT INTO ProductVariants (ProductId, SKU, VariantName, Price, CostPrice, StockQuantity, ImageUrl, CreatedDate)
VALUES (@Pid, N'KOZ-LỌC23-AIRBLADE', N'Airblade', 2021748.0, 1617398.4000000001, 49, N'https://malossistore.vn/img/p/product_23.jpg', GETDATE());
SET @Vid = SCOPE_IDENTITY();
IF NOT EXISTS (SELECT 1 FROM ProductAttributes WHERE AttributeName = N'Loại xe') INSERT INTO ProductAttributes (AttributeName) VALUES (N'Loại xe');
SET @Aid = (SELECT AttributeId FROM ProductAttributes WHERE AttributeName = N'Loại xe');
IF NOT EXISTS (SELECT 1 FROM AttributeValues WHERE AttributeId = @Aid AND Value = N'Airblade') INSERT INTO AttributeValues (AttributeId, Value) VALUES (@Aid, N'Airblade');
...
IF NOT EXISTS (SELECT 1 FROM ProductVariantAttributeValue WHERE ProductVariantId = @Vid AND ValueId = @Valid) INSERT INTO ProductVariantAttributeValue (ProductVariantId, ValueId) VALUES (@Vid, @Valid);
INSERT INTO ProductVariants (ProductId, SKU, VariantName, Price, CostPrice, StockQuantity, ImageUrl, CreatedDate)
VALUES (@Pid, N'KOZ-LỌC23-EXCITER', N'Exciter', 2014328.0, 1611462.4000000001, 45, N'https://malossistore.vn/img/p/product_23.jpg', GETDATE());
SET @Vid = SCOPE_IDENTITY();
IF NOT EXISTS (SELECT 1 FROM ProductAttributes WHERE AttributeName = N'Kích thước') INSERT INTO ProductAttributes (AttributeName) VALUES (N'Kích thước');
SET @Aid = (SELECT AttributeId FROM ProductAttributes WHERE AttributeName = N'Kích thước');
IF NOT EXISTS (SELECT 1 FROM AttributeValues WHERE AttributeId = @Aid AND Value = N'Exciter') INSERT INTO AttributeValues (AttributeId, Value) VALUES (@Aid, N'Exciter');
...
INSERT INTO ProductVariants (ProductId, SKU, VariantName, Price, CostPrice, StockQuantity, ImageUrl, CreatedDate)
VALUES (@Pid, N'FAI-LỌC24-VARIO/CLICK', N'Vario/Click', 2824641.0, 2259712.8000000003, 47, N'https://faito.com.vn/wp-content/uploads/product_24.jpg', GETDATE());
SET @Vid = SCOPE_IDENTITY();
IF NOT EXISTS (SELECT 1 FROM ProductAttributes WHERE AttributeName = N'Loại xe') INSERT INTO ProductAttributes (AttributeName) VALUES (N'Loại xe');
SET @Aid = (SELECT AttributeId FROM ProductAttributes WHERE AttributeName = N'Loại xe');
IF NOT EXISTS (SELECT 1 FROM AttributeValues WHERE AttributeId = @Aid AND Value = N'Vario/Click') INSERT INTO AttributeValues (AttributeId, Value) VALUES (@Aid, N'Vario/Click');
...
IF NOT EXISTS (SELECT 1 FROM ProductVariantAttributeValue WHERE ProductVariantId = @Vid AND ValueId = @Valid) INSERT INTO ProductVariantAttributeValue (ProductVariantId, ValueId) VALUES (@Vid, @Valid);
INSERT INTO ProductVariants (ProductId, SKU, VariantName, Price, CostPrice, StockQuantity, ImageUrl, CreatedDate)
VALUES (@Pid, N'FAI-LỌC24-AIRBLADE', N'Airblade', 2824311.0, 2259448.8000000003, 21, N'https://faito.com.vn/wp-content/uploads/product_24.jpg', GETDATE());
SET @Vid = SCOPE_IDENTITY();
IF NOT EXISTS (SELECT 1 FROM ProductAttributes WHERE AttributeName = N'Loại xe') INSERT INTO ProductAttributes (AttributeName) VALUES (N'Loại xe');
SET @Aid = (SELECT AttributeId FROM ProductAttributes WHERE AttributeName = N'Loại xe');
IF NOT EXISTS (SELECT 1 FROM AttributeValues WHERE AttributeId = @Aid AND Value = N'Airblade') INSERT INTO AttributeValues (AttributeId, Value) VALUES (@Aid, N'Airblade');
...
IF NOT EXISTS (SELECT 1 FROM ProductVariantAttributeValue WHERE ProductVariantId = @Vid AND ValueId = @Valid) INSERT INTO ProductVariantAttributeValue (ProductVariantId, ValueId) VALUES (@Vid, @Valid);
INSERT INTO ProductVariants (ProductId, SKU, VariantName, Price, CostPrice, StockQuantity, ImageUrl, CreatedDate)
VALUES (@Pid, N'MAL-LỌC25-AIRBLADE', N'Airblade', 3584563.0, 2867650.4000000004, 29, N'https://motobatt.com/image/cache/product_25.jpg', GETDATE());
SET @Vid = SCOPE_IDENTITY();
IF NOT EXISTS (SELECT 1 FROM ProductAttributes WHERE AttributeName = N'Loại xe') INSERT INTO ProductAttributes (AttributeName) VALUES (N'Loại xe');
SET @Aid = (SELECT AttributeId FROM ProductAttributes WHERE AttributeName = N'Loại xe');
IF NOT EXISTS (SELECT 1 FROM AttributeValues WHERE AttributeId = @Aid AND Value = N'Airblade') INSERT INTO AttributeValues (AttributeId, Value) VALUES (@Aid, N'Airblade');
...
IF NOT EXISTS (SELECT 1 FROM ProductVariantAttributeValue WHERE ProductVariantId = @Vid AND ValueId = @Valid) INSERT INTO ProductVariantAttributeValue (ProductVariantId, ValueId) VALUES (@Vid, @Valid);
INSERT INTO ProductVariants (ProductId, SKU, VariantName, Price, CostPrice, StockQuantity, ImageUrl, CreatedDate)
VALUES (@Pid, N'MAL-LỌC25-EXCITER', N'Exciter', 3595456.0, 2876364.8000000003, 33, N'https://motobatt.com/image/cache/product_25.jpg', GETDATE());
SET @Vid = SCOPE_IDENTITY();
IF NOT EXISTS (SELECT 1 FROM ProductAttributes WHERE AttributeName = N'Kích thước') INSERT INTO ProductAttributes (AttributeName) VALUES (N'Kích thước');
SET @Aid = (SELECT AttributeId FROM ProductAttributes WHERE AttributeName = N'Kích thước');
IF NOT EXISTS (SELECT 1 FROM AttributeValues WHERE AttributeId = @Aid AND Value = N'Exciter') INSERT INTO AttributeValues (AttributeId, Value) VALUES (@Aid, N'Exciter');
...
INSERT INTO ProductVariants (ProductId, SKU, VariantName, Price, CostPrice, StockQuantity, ImageUrl, CreatedDate)
VALUES (@Pid, N'RGV-NHỚ26-0.8L', N'0.8L', 2079648.0, 1663718.4000000001, 22, N'https://faito.com.vn/wp-content/uploads/product_26.jpg', GETDATE());
SET @Vid = SCOPE_IDENTITY();
...
IF NOT EXISTS (SELECT 1 FROM ProductVariantAttributeValue WHERE ProductVariantId = @Vid AND ValueId = @Valid) INSERT INTO ProductVariantAttributeValue (ProductVariantId, ValueId) VALUES (@Vid, @Valid);
INSERT INTO ProductVariants (ProductId, SKU, VariantName, Price, CostPrice, StockQuantity, ImageUrl, CreatedDate)
VALUES (@Pid, N'RGV-NHỚ26-1.1L', N'1.1L', 2086268.0, 1669014.4000000001, 46, N'https://faito.com.vn/wp-content/uploads/product_26.jpg', GETDATE());
SET @Vid = SCOPE_IDENTITY();
IF NOT EXISTS (SELECT 1 FROM ProductAttributes WHERE AttributeName = N'Dung tích') INSERT INTO ProductAttributes (AttributeName) VALUES (N'Dung tích');
SET @Aid = (SELECT AttributeId FROM ProductAttributes WHERE AttributeName = N'Dung tích');
...
IF NOT EXISTS (SELECT 1 FROM ProductVariantAttributeValue WHERE ProductVariantId = @Vid AND ValueId = @Valid) INSERT INTO ProductVariantAttributeValue (ProductVariantId, ValueId) VALUES (@Vid, @Valid);
INSERT INTO ProductVariants (ProductId, SKU, VariantName, Price, CostPrice, StockQuantity, ImageUrl, CreatedDate)
VALUES (@Pid, N'FAI-NHỚ27-1.2L', N'1.2L', 925097.0, 740077.6000000001, 49, N'https://malossistore.vn/img/p/product_27.jpg', GETDATE());
SET @Vid = SCOPE_IDENTITY();
IF NOT EXISTS (SELECT 1 FROM ProductAttributes WHERE AttributeName = N'Dung tích') INSERT INTO ProductAttributes (AttributeName) VALUES (N'Dung tích');
SET @Aid = (SELECT AttributeId FROM ProductAttributes WHERE AttributeName = N'Dung tích');
IF NOT EXISTS (SELECT 1 FROM AttributeValues WHERE AttributeId = @Aid AND Value = N'1.2L') INSERT INTO AttributeValues (AttributeId, Value) VALUES (@Aid, N'1.2L');
...
IF NOT EXISTS (SELECT 1 FROM ProductVariantAttributeValue WHERE ProductVariantId = @Vid AND ValueId = @Valid) INSERT INTO ProductVariantAttributeValue (ProductVariantId, ValueId) VALUES (@Vid, @Valid);
INSERT INTO ProductVariants (ProductId, SKU, VariantName, Price, CostPrice, StockQuantity, ImageUrl, CreatedDate)
VALUES (@Pid, N'MAL-NHỚ28-1.2L', N'1.2L', 2498424.0, 1998739.2000000002, 20, N'https://motobatt.com/image/cache/product_28.jpg', GETDATE());
SET @Vid = SCOPE_IDENTITY();
IF NOT EXISTS (SELECT 1 FROM ProductAttributes WHERE AttributeName = N'Dung tích') INSERT INTO ProductAttributes (AttributeName) VALUES (N'Dung tích');
SET @Aid = (SELECT AttributeId FROM ProductAttributes WHERE AttributeName = N'Dung tích');
IF NOT EXISTS (SELECT 1 FROM AttributeValues WHERE AttributeId = @Aid AND Value = N'1.2L') INSERT INTO AttributeValues (AttributeId, Value) VALUES (@Aid, N'1.2L');
...
INSERT INTO ProductVariants (ProductId, SKU, VariantName, Price, CostPrice, StockQuantity, ImageUrl, CreatedDate)
VALUES (@Pid, N'RGV-NHỚ29-0.8L', N'0.8L', 3742941.0, 2994352.8000000003, 7, N'https://malossistore.vn/img/p/product_29.jpg', GETDATE());
SET @Vid = SCOPE_IDENTITY();
IF NOT EXISTS (SELECT 1 FROM ProductAttributes WHERE AttributeName = N'Dung tích') INSERT INTO ProductAttributes (AttributeName) VALUES (N'Dung tích');
SET @Aid = (SELECT AttributeId FROM ProductAttributes WHERE AttributeName = N'Dung tích');
IF NOT EXISTS (SELECT 1 FROM AttributeValues WHERE AttributeId = @Aid AND Value = N'0.8L') INSERT INTO AttributeValues (AttributeId, Value) VALUES (@Aid, N'0.8L');
...
IF NOT EXISTS (SELECT 1 FROM ProductVariantAttributeValue WHERE ProductVariantId = @Vid AND ValueId = @Valid) INSERT INTO ProductVariantAttributeValue (ProductVariantId, ValueId) VALUES (@Vid, @Valid);
INSERT INTO ProductVariants (ProductId, SKU, VariantName, Price, CostPrice, StockQuantity, ImageUrl, CreatedDate)
VALUES (@Pid, N'RGV-NHỚ30-1L', N'1L', 218381.0, 174704.80000000002, 5, N'https://faito.com.vn/wp-content/uploads/product_30.jpg', GETDATE());
SET @Vid = SCOPE_IDENTITY();
IF NOT EXISTS (SELECT 1 FROM ProductAttributes WHERE AttributeName = N'Dung tích') INSERT INTO ProductAttributes (AttributeName) VALUES (N'Dung tích');
SET @Aid = (SELECT AttributeId FROM ProductAttributes WHERE AttributeName = N'Dung tích');
IF NOT EXISTS (SELECT 1 FROM AttributeValues WHERE AttributeId = @Aid AND Value = N'1L') INSERT INTO AttributeValues (AttributeId, Value) VALUES (@Aid, N'1L');
...
IF NOT EXISTS (SELECT 1 FROM ProductVariantAttributeValue WHERE ProductVariantId = @Vid AND ValueId = @Valid) INSERT INTO ProductVariantAttributeValue (ProductVariantId, ValueId) VALUES (@Vid, @Valid);
INSERT INTO ProductVariants (ProductId, SKU, VariantName, Price, CostPrice, StockQuantity, ImageUrl, CreatedDate)
VALUES (@Pid, N'RGV-NHỚ30-1.1L', N'1.1L', 162589.0, 130071.20000000001, 27, N'https://faito.com.vn/wp-content/uploads/product_30.jpg', GETDATE());
SET @Vid = SCOPE_IDENTITY();
IF NOT EXISTS (SELECT 1 FROM ProductAttributes WHERE AttributeName = N'Dung tích') INSERT INTO ProductAttributes (AttributeName) VALUES (N'Dung tích');
SET @Aid = (SELECT AttributeId FROM ProductAttributes WHERE AttributeName = N'Dung tích');
IF NOT EXISTS (SELECT 1 FROM AttributeValues WHERE AttributeId = @Aid AND Value = N'1.1L') INSERT INTO AttributeValues (AttributeId, Value) VALUES (@Aid, N'1.1L');
...
IF NOT EXISTS (SELECT 1 FROM ProductVariantAttributeValue WHERE ProductVariantId = @Vid AND ValueId = @Valid) INSERT INTO ProductVariantAttributeValue (ProductVariantId, ValueId) VALUES (@Vid, @Valid);
INSERT INTO ProductVariants (ProductId, SKU, VariantName, Price, CostPrice, StockQuantity, ImageUrl, CreatedDate)
VALUES (@Pid, N'RGV-BỐ 32-SAU(REAR)', N'Sau (Rear)', 591167.0, 472933.60000000003, 48, N'https://motobatt.com/image/cache/product_32.jpg', GETDATE());
SET @Vid = SCOPE_IDENTITY();
IF NOT EXISTS (SELECT 1 FROM ProductAttributes WHERE AttributeName = N'Vị trí') INSERT INTO ProductAttributes (AttributeName) VALUES (N'Vị trí');
SET @Aid = (SELECT AttributeId FROM ProductAttributes WHERE AttributeName = N'Vị trí');
IF NOT EXISTS (SELECT 1 FROM AttributeValues WHERE AttributeId = @Aid AND Value = N'Sau (Rear)') INSERT INTO AttributeValues (AttributeId, Value) VALUES (@Aid, N'Sau (Rear)');
...
INSERT INTO ProductVariants (ProductId, SKU, VariantName, Price, CostPrice, StockQuantity, ImageUrl, CreatedDate)
VALUES (@Pid, N'FAI-BỐ 33-TRƯỚC(FRONT)', N'Trước (Front)', 635551.0, 508440.80000000005, 22, N'https://faito.com.vn/wp-content/uploads/product_33.jpg', GETDATE());
SET @Vid = SCOPE_IDENTITY();
IF NOT EXISTS (SELECT 1 FROM ProductAttributes WHERE AttributeName = N'Thông số') INSERT INTO ProductAttributes (AttributeName) VALUES (N'Thông số');
SET @Aid = (SELECT AttributeId FROM ProductAttributes WHERE AttributeName = N'Thông số');
IF NOT EXISTS (SELECT 1 FROM AttributeValues WHERE AttributeId = @Aid AND Value = N'Trước (Front)') INSERT INTO AttributeValues (AttributeId, Value) VALUES (@Aid, N'Trước (Front)');
...
IF NOT EXISTS (SELECT 1 FROM ProductVariantAttributeValue WHERE ProductVariantId = @Vid AND ValueId = @Valid) INSERT INTO ProductVariantAttributeValue (ProductVariantId, ValueId) VALUES (@Vid, @Valid);
INSERT INTO ProductVariants (ProductId, SKU, VariantName, Price, CostPrice, StockQuantity, ImageUrl, CreatedDate)
VALUES (@Pid, N'FKR-VỎ 38-80/90-17', N'80/90-17', 261761.0, 209408.80000000002, 25, N'https://faito.com.vn/wp-content/uploads/product_38.jpg', GETDATE());
SET @Vid = SCOPE_IDENTITY();
IF NOT EXISTS (SELECT 1 FROM ProductAttributes WHERE AttributeName = N'Khác') INSERT INTO ProductAttributes (AttributeName) VALUES (N'Khác');
SET @Aid = (SELECT AttributeId FROM ProductAttributes WHERE AttributeName = N'Khác');
IF NOT EXISTS (SELECT 1 FROM AttributeValues WHERE AttributeId = @Aid AND Value = N'80/90-17') INSERT INTO AttributeValues (AttributeId, Value) VALUES (@Aid, N'80/90-17');
...
IF NOT EXISTS (SELECT 1 FROM ProductVariantAttributeValue WHERE ProductVariantId = @Vid AND ValueId = @Valid) INSERT INTO ProductVariantAttributeValue (ProductVariantId, ValueId) VALUES (@Vid, @Valid);
INSERT INTO ProductVariants (ProductId, SKU, VariantName, Price, CostPrice, StockQuantity, ImageUrl, CreatedDate)
VALUES (@Pid, N'FKR-VỎ 38-90/80-17', N'90/80-17', 232606.0, 186084.80000000002, 15, N'https://faito.com.vn/wp-content/uploads/product_38.jpg', GETDATE());
SET @Vid = SCOPE_IDENTITY();
IF NOT EXISTS (SELECT 1 FROM ProductAttributes WHERE AttributeName = N'Khác') INSERT INTO ProductAttributes (AttributeName) VALUES (N'Khác');
SET @Aid = (SELECT AttributeId FROM ProductAttributes WHERE AttributeName = N'Khác');
IF NOT EXISTS (SELECT 1 FROM AttributeValues WHERE AttributeId = @Aid AND Value = N'90/80-17') INSERT INTO AttributeValues (AttributeId, Value) VALUES (@Aid, N'90/80-17');
...
IF NOT EXISTS (SELECT 1 FROM ProductVariantAttributeValue WHERE ProductVariantId = @Vid AND ValueId = @Valid) INSERT INTO ProductVariantAttributeValue (ProductVariantId, ValueId) VALUES (@Vid, @Valid);
INSERT INTO ProductVariants (ProductId, SKU, VariantName, Price, CostPrice, StockQuantity, ImageUrl, CreatedDate)
VALUES (@Pid, N'TR -VỎ 39-90/80-17', N'90/80-17', 481457.0, 385165.60000000003, 9, N'https://faito.com.vn/wp-content/uploads/product_39.jpg', GETDATE());
SET @Vid = SCOPE_IDENTITY();
IF NOT EXISTS (SELECT 1 FROM ProductAttributes WHERE AttributeName = N'Khác') INSERT INTO ProductAttributes (AttributeName) VALUES (N'Khác');
SET @Aid = (SELECT AttributeId FROM ProductAttributes WHERE AttributeName = N'Khác');
IF NOT EXISTS (SELECT 1 FROM AttributeValues WHERE AttributeId = @Aid AND Value = N'90/80-17') INSERT INTO AttributeValues (AttributeId, Value) VALUES (@Aid, N'90/80-17');
...
IF NOT EXISTS (SELECT 1 FROM ProductVariantAttributeValue WHERE ProductVariantId = @Vid AND ValueId = @Valid) INSERT INTO ProductVariantAttributeValue (ProductVariantId, ValueId) VALUES (@Vid, @Valid);
INSERT INTO ProductVariants (ProductId, SKU, VariantName, Price, CostPrice, StockQuantity, ImageUrl, CreatedDate)
VALUES (@Pid, N'TR -VỎ 40-100/80-17', N'100/80-17', 1293202.0, 1034561.6000000001, 7, N'https://faito.com.vn/wp-content/uploads/product_40.jpg', GETDATE());
SET @Vid = SCOPE_IDENTITY();
IF NOT EXISTS (SELECT 1 FROM ProductAttributes WHERE AttributeName = N'Khác') INSERT INTO ProductAttributes (AttributeName) VALUES (N'Khác');
SET @Aid = (SELECT AttributeId FROM ProductAttributes WHERE AttributeName = N'Khác');
IF NOT EXISTS (SELECT 1 FROM AttributeValues WHERE AttributeId = @Aid AND Value = N'100/80-17') INSERT INTO AttributeValues (AttributeId, Value) VALUES (@Aid, N'100/80-17');
...
INSERT INTO ProductVariants (ProductId, SKU, VariantName, Price, CostPrice, StockQuantity, ImageUrl, CreatedDate)
VALUES (@Pid, N'API-DÂY41-TIÊUCHUẨN', N'Tiêu chuẩn', 1211852.0, 969481.6000000001, 24, N'https://faito.com.vn/wp-content/uploads/product_41.jpg', GETDATE());
SET @Vid = SCOPE_IDENTITY();
IF NOT EXISTS (SELECT 1 FROM ProductAttributes WHERE AttributeName = N'Thông số') INSERT INTO ProductAttributes (AttributeName) VALUES (N'Thông số');
SET @Aid = (SELECT AttributeId FROM ProductAttributes WHERE AttributeName = N'Thông số');
...
IF NOT EXISTS (SELECT 1 FROM ProductVariantAttributeValue WHERE ProductVariantId = @Vid AND ValueId = @Valid) INSERT INTO ProductVariantAttributeValue (ProductVariantId, ValueId) VALUES (@Vid, @Valid);
INSERT INTO ProductVariants (ProductId, SKU, VariantName, Price, CostPrice, StockQuantity, ImageUrl, CreatedDate)
VALUES (@Pid, N'API-DÂY41-DÀIHƠN10CM', N'Dài hơn 10cm', 1205654.0, 964523.2000000001, 23, N'https://faito.com.vn/wp-content/uploads/product_41.jpg', GETDATE());
SET @Vid = SCOPE_IDENTITY();
IF NOT EXISTS (SELECT 1 FROM ProductAttributes WHERE AttributeName = N'Khác') INSERT INTO ProductAttributes (AttributeName) VALUES (N'Khác');
SET @Aid = (SELECT AttributeId FROM ProductAttributes WHERE AttributeName = N'Khác');
...
IF NOT EXISTS (SELECT 1 FROM ProductVariantAttributeValue WHERE ProductVariantId = @Vid AND ValueId = @Valid) INSERT INTO ProductVariantAttributeValue (ProductVariantId, ValueId) VALUES (@Vid, @Valid);
INSERT INTO ProductVariants (ProductId, SKU, VariantName, Price, CostPrice, StockQuantity, ImageUrl, CreatedDate)
VALUES (@Pid, N'KOZ-DÂY42-DÀIHƠN5CM', N'Dài hơn 5cm', 2470064.0, 1976051.2000000002, 33, N'https://malossistore.vn/img/p/product_42.jpg', GETDATE());
SET @Vid = SCOPE_IDENTITY();
IF NOT EXISTS (SELECT 1 FROM ProductAttributes WHERE AttributeName = N'Khác') INSERT INTO ProductAttributes (AttributeName) VALUES (N'Khác');
SET @Aid = (SELECT AttributeId FROM ProductAttributes WHERE AttributeName = N'Khác');
IF NOT EXISTS (SELECT 1 FROM AttributeValues WHERE AttributeId = @Aid AND Value = N'Dài hơn 5cm') INSERT INTO AttributeValues (AttributeId, Value) VALUES (@Aid, N'Dài hơn 5cm');
...
INSERT INTO ProductVariants (ProductId, SKU, VariantName, Price, CostPrice, StockQuantity, ImageUrl, CreatedDate)
VALUES (@Pid, N'RGV-DÂY44-TIÊUCHUẨN', N'Tiêu chuẩn', 163159.0, 130527.20000000001, 31, N'https://motobatt.com/image/cache/product_44.jpg', GETDATE());
SET @Vid = SCOPE_IDENTITY();
IF NOT EXISTS (SELECT 1 FROM ProductAttributes WHERE AttributeName = N'Thông số') INSERT INTO ProductAttributes (AttributeName) VALUES (N'Thông số');
SET @Aid = (SELECT AttributeId FROM ProductAttributes WHERE AttributeName = N'Thông số');
IF NOT EXISTS (SELECT 1 FROM AttributeValues WHERE AttributeId = @Aid AND Value = N'Tiêu chuẩn') INSERT INTO AttributeValues (AttributeId, Value) VALUES (@Aid, N'Tiêu chuẩn');
...
IF NOT EXISTS (SELECT 1 FROM ProductVariantAttributeValue WHERE ProductVariantId = @Vid AND ValueId = @Valid) INSERT INTO ProductVariantAttributeValue (ProductVariantId, ValueId) VALUES (@Vid, @Valid);
INSERT INTO ProductVariants (ProductId, SKU, VariantName, Price, CostPrice, StockQuantity, ImageUrl, CreatedDate)
VALUES (@Pid, N'YSS-PHU46-LIMITEDEDITION', N'Limited Edition', 2289148.0, 1831318.4000000001, 25, N'https://malossistore.vn/img/p/product_46.jpg', GETDATE());
SET @Vid = SCOPE_IDENTITY();
IF NOT EXISTS (SELECT 1 FROM ProductAttributes WHERE AttributeName = N'Dung tích') INSERT INTO ProductAttributes (AttributeName) VALUES (N'Dung tích');
SET @Aid = (SELECT AttributeId FROM ProductAttributes WHERE AttributeName = N'Dung tích');
...
IF NOT EXISTS (SELECT 1 FROM ProductVariantAttributeValue WHERE ProductVariantId = @Vid AND ValueId = @Valid) INSERT INTO ProductVariantAttributeValue (ProductVariantId, ValueId) VALUES (@Vid, @Valid);
INSERT INTO ProductVariants (ProductId, SKU, VariantName, Price, CostPrice, StockQuantity, ImageUrl, CreatedDate)
VALUES (@Pid, N'YSS-PHU47-RACING', N'Racing', 919967.0, 735973.6000000001, 40, N'https://faito.com.vn/wp-content/uploads/product_47.jpg', GETDATE());
SET @Vid = SCOPE_IDENTITY();
IF NOT EXISTS (SELECT 1 FROM ProductAttributes WHERE AttributeName = N'Trọng lượng') INSERT INTO ProductAttributes (AttributeName) VALUES (N'Trọng lượng');
SET @Aid = (SELECT AttributeId FROM ProductAttributes WHERE AttributeName = N'Trọng lượng');
IF NOT EXISTS (SELECT 1 FROM AttributeValues WHERE AttributeId = @Aid AND Value = N'Racing') INSERT INTO AttributeValues (AttributeId, Value) VALUES (@Aid, N'Racing');
...
IF NOT EXISTS (SELECT 1 FROM ProductVariantAttributeValue WHERE ProductVariantId = @Vid AND ValueId = @Valid) INSERT INTO ProductVariantAttributeValue (ProductVariantId, ValueId) VALUES (@Vid, @Valid);
INSERT INTO ProductVariants (ProductId, SKU, VariantName, Price, CostPrice, StockQuantity, ImageUrl, CreatedDate)
VALUES (@Pid, N'YSS-PHU47-LIMITEDEDITION', N'Limited Edition', 963424.0, 770739.2000000001, 11, N'https://faito.com.vn/wp-content/uploads/product_47.jpg', GETDATE());
SET @Vid = SCOPE_IDENTITY();
IF NOT EXISTS (SELECT 1 FROM ProductAttributes WHERE AttributeName = N'Dung tích') INSERT INTO ProductAttributes (AttributeName) VALUES (N'Dung tích');
SET @Aid = (SELECT AttributeId FROM ProductAttributes WHERE AttributeName = N'Dung tích');
IF NOT EXISTS (SELECT 1 FROM AttributeValues WHERE AttributeId = @Aid AND Value = N'Limited Edition') INSERT INTO AttributeValues (AttributeId, Value) VALUES (@Aid, N'Limited Edition');
...
IF NOT EXISTS (SELECT 1 FROM ProductVariantAttributeValue WHERE ProductVariantId = @Vid AND ValueId = @Valid) INSERT INTO ProductVariantAttributeValue (ProductVariantId, ValueId) VALUES (@Vid, @Valid);
INSERT INTO ProductVariants (ProductId, SKU, VariantName, Price, CostPrice, StockQuantity, ImageUrl, CreatedDate)
VALUES (@Pid, N'YSS-PHU49-LIMITEDEDITION', N'Limited Edition', 2999036.0, 2399228.8000000003, 40, N'https://motobatt.com/image/cache/product_49.jpg', GETDATE());
SET @Vid = SCOPE_IDENTITY();
IF NOT EXISTS (SELECT 1 FROM ProductAttributes WHERE AttributeName = N'Dung tích') INSERT INTO ProductAttributes (AttributeName) VALUES (N'Dung tích');
SET @Aid = (SELECT AttributeId FROM ProductAttributes WHERE AttributeName = N'Dung tích');
IF NOT EXISTS (SELECT 1 FROM AttributeValues WHERE AttributeId = @Aid AND Value = N'Limited Edition') INSERT INTO AttributeValues (AttributeId, Value) VALUES (@Aid, N'Limited Edition');
...
IF NOT EXISTS (SELECT 1 FROM ProductVariantAttributeValue WHERE ProductVariantId = @Vid AND ValueId = @Valid) INSERT INTO ProductVariantAttributeValue (ProductVariantId, ValueId) VALUES (@Vid, @Valid);
INSERT INTO ProductVariants (ProductId, SKU, VariantName, Price, CostPrice, StockQuantity, ImageUrl, CreatedDate)
VALUES (@Pid, N'CRG-PHU50-RACING', N'Racing', 1634723.0, 1307778.4000000001, 31, N'https://faito.com.vn/wp-content/uploads/product_50.jpg', GETDATE());
SET @Vid = SCOPE_IDENTITY();
IF NOT EXISTS (SELECT 1 FROM ProductAttributes WHERE AttributeName = N'Trọng lượng') INSERT INTO ProductAttributes (AttributeName) VALUES (N'Trọng lượng');
SET @Aid = (SELECT AttributeId FROM ProductAttributes WHERE AttributeName = N'Trọng lượng');
IF NOT EXISTS (SELECT 1 FROM AttributeValues WHERE AttributeId = @Aid AND Value = N'Racing') INSERT INTO AttributeValues (AttributeId, Value) VALUES (@Aid, N'Racing');
...
IF NOT EXISTS (SELECT 1 FROM ProductVariantAttributeValue WHERE ProductVariantId = @Vid AND ValueId = @Valid) INSERT INTO ProductVariantAttributeValue (ProductVariantId, ValueId) VALUES (@Vid, @Valid);
INSERT INTO ProductVariants (ProductId, SKU, VariantName, Price, CostPrice, StockQuantity, ImageUrl, CreatedDate)
VALUES (@Pid, N'KOZ-BỘ 51-EXCITER/WINNER', N'Exciter/Winner', 340677.0, 272541.60000000003, 5, N'https://motobatt.com/image/cache/product_51.jpg', GETDATE());
SET @Vid = SCOPE_IDENTITY();
IF NOT EXISTS (SELECT 1 FROM ProductAttributes WHERE AttributeName = N'Kích thước') INSERT INTO ProductAttributes (AttributeName) VALUES (N'Kích thước');
SET @Aid = (SELECT AttributeId FROM ProductAttributes WHERE AttributeName = N'Kích thước');
...
INSERT INTO ProductVariants (ProductId, SKU, VariantName, Price, CostPrice, StockQuantity, ImageUrl, CreatedDate)
VALUES (@Pid, N'RGV-BỘ 52-WAVE/DREAM', N'Wave/Dream', 848124.0, 678499.2000000001, 39, N'https://malossistore.vn/img/p/product_52.jpg', GETDATE());
SET @Vid = SCOPE_IDENTITY();
IF NOT EXISTS (SELECT 1 FROM ProductAttributes WHERE AttributeName = N'Loại xe') INSERT INTO ProductAttributes (AttributeName) VALUES (N'Loại xe');
SET @Aid = (SELECT AttributeId FROM ProductAttributes WHERE AttributeName = N'Loại xe');
IF NOT EXISTS (SELECT 1 FROM AttributeValues WHERE AttributeId = @Aid AND Value = N'Wave/Dream') INSERT INTO AttributeValues (AttributeId, Value) VALUES (@Aid, N'Wave/Dream');
...
IF NOT EXISTS (SELECT 1 FROM ProductVariantAttributeValue WHERE ProductVariantId = @Vid AND ValueId = @Valid) INSERT INTO ProductVariantAttributeValue (ProductVariantId, ValueId) VALUES (@Vid, @Valid);
INSERT INTO ProductVariants (ProductId, SKU, VariantName, Price, CostPrice, StockQuantity, ImageUrl, CreatedDate)
VALUES (@Pid, N'RGV-BỘ 52-EXCITER/WINNER', N'Exciter/Winner', 837757.0, 670205.6000000001, 43, N'https://malossistore.vn/img/p/product_52.jpg', GETDATE());
SET @Vid = SCOPE_IDENTITY();
IF NOT EXISTS (SELECT 1 FROM ProductAttributes WHERE AttributeName = N'Kích thước') INSERT INTO ProductAttributes (AttributeName) VALUES (N'Kích thước');
SET @Aid = (SELECT AttributeId FROM ProductAttributes WHERE AttributeName = N'Kích thước');
IF NOT EXISTS (SELECT 1 FROM AttributeValues WHERE AttributeId = @Aid AND Value = N'Exciter/Winner') INSERT INTO AttributeValues (AttributeId, Value) VALUES (@Aid, N'Exciter/Winner');
...
IF NOT EXISTS (SELECT 1 FROM ProductVariantAttributeValue WHERE ProductVariantId = @Vid AND ValueId = @Valid) INSERT INTO ProductVariantAttributeValue (ProductVariantId, ValueId) VALUES (@Vid, @Valid);
INSERT INTO ProductVariants (ProductId, SKU, VariantName, Price, CostPrice, StockQuantity, ImageUrl, CreatedDate)
VALUES (@Pid, N'RGV-BỘ 52-VARIO/VISION', N'Vario/Vision', 843767.0, 675013.6000000001, 19, N'https://malossistore.vn/img/p/product_52.jpg', GETDATE());
SET @Vid = SCOPE_IDENTITY();
IF NOT EXISTS (SELECT 1 FROM ProductAttributes WHERE AttributeName = N'Loại xe') INSERT INTO ProductAttributes (AttributeName) VALUES (N'Loại xe');
SET @Aid = (SELECT AttributeId FROM ProductAttributes WHERE AttributeName = N'Loại xe');
IF NOT EXISTS (SELECT 1 FROM AttributeValues WHERE AttributeId = @Aid AND Value = N'Vario/Vision') INSERT INTO AttributeValues (AttributeId, Value) VALUES (@Aid, N'Vario/Vision');
...
INSERT INTO ProductVariants (ProductId, SKU, VariantName, Price, CostPrice, StockQuantity, ImageUrl, CreatedDate)
VALUES (@Pid, N'RGV-BỘ 54-WAVE/DREAM', N'Wave/Dream', 2066628.0, 1653302.4000000001, 26, N'https://motobatt.com/image/cache/product_54.jpg', GETDATE());
SET @Vid = SCOPE_IDENTITY();
IF NOT EXISTS (SELECT 1 FROM ProductAttributes WHERE AttributeName = N'Loại xe') INSERT INTO ProductAttributes (AttributeName) VALUES (N'Loại xe');
SET @Aid = (SELECT AttributeId FROM ProductAttributes WHERE AttributeName = N'Loại xe');
IF NOT EXISTS (SELECT 1 FROM AttributeValues WHERE AttributeId = @Aid AND Value = N'Wave/Dream') INSERT INTO AttributeValues (AttributeId, Value) VALUES (@Aid, N'Wave/Dream');
...
IF NOT EXISTS (SELECT 1 FROM ProductVariantAttributeValue WHERE ProductVariantId = @Vid AND ValueId = @Valid) INSERT INTO ProductVariantAttributeValue (ProductVariantId, ValueId) VALUES (@Vid, @Valid);
INSERT INTO ProductVariants (ProductId, SKU, VariantName, Price, CostPrice, StockQuantity, ImageUrl, CreatedDate)
VALUES (@Pid, N'KOZ-PHỤ56-ĐEN', N'Đen', 1711334.0, 1369067.2000000002, 38, N'https://faito.com.vn/wp-content/uploads/product_56.jpg', GETDATE());
SET @Vid = SCOPE_IDENTITY();
IF NOT EXISTS (SELECT 1 FROM ProductAttributes WHERE AttributeName = N'Màu sắc') INSERT INTO ProductAttributes (AttributeName) VALUES (N'Màu sắc');
SET @Aid = (SELECT AttributeId FROM ProductAttributes WHERE AttributeName = N'Màu sắc');
...
IF NOT EXISTS (SELECT 1 FROM ProductVariantAttributeValue WHERE ProductVariantId = @Vid AND ValueId = @Valid) INSERT INTO ProductVariantAttributeValue (ProductVariantId, ValueId) VALUES (@Vid, @Valid);
INSERT INTO ProductVariants (ProductId, SKU, VariantName, Price, CostPrice, StockQuantity, ImageUrl, CreatedDate)
VALUES (@Pid, N'YSS-PHỤ57-ĐỎ', N'Đỏ', 1116622.0, 893297.6000000001, 22, N'https://malossistore.vn/img/p/product_57.jpg', GETDATE());
SET @Vid = SCOPE_IDENTITY();
IF NOT EXISTS (SELECT 1 FROM ProductAttributes WHERE AttributeName = N'Màu sắc') INSERT INTO ProductAttributes (AttributeName) VALUES (N'Màu sắc');
SET @Aid = (SELECT AttributeId FROM ProductAttributes WHERE AttributeName = N'Màu sắc');
IF NOT EXISTS (SELECT 1 FROM AttributeValues WHERE AttributeId = @Aid AND Value = N'Đỏ') INSERT INTO AttributeValues (AttributeId, Value) VALUES (@Aid, N'Đỏ');
...
IF NOT EXISTS (SELECT 1 FROM ProductVariantAttributeValue WHERE ProductVariantId = @Vid AND ValueId = @Valid) INSERT INTO ProductVariantAttributeValue (ProductVariantId, ValueId) VALUES (@Vid, @Valid);
INSERT INTO ProductVariants (ProductId, SKU, VariantName, Price, CostPrice, StockQuantity, ImageUrl, CreatedDate)
VALUES (@Pid, N'YSS-PHỤ57-XANH', N'Xanh', 1115227.0, 892181.6000000001, 29, N'https://malossistore.vn/img/p/product_57.jpg', GETDATE());
SET @Vid = SCOPE_IDENTITY();
IF NOT EXISTS (SELECT 1 FROM ProductAttributes WHERE AttributeName = N'Màu sắc') INSERT INTO ProductAttributes (AttributeName) VALUES (N'Màu sắc');
SET @Aid = (SELECT AttributeId FROM ProductAttributes WHERE AttributeName = N'Màu sắc');
IF NOT EXISTS (SELECT 1 FROM AttributeValues WHERE AttributeId = @Aid AND Value = N'Xanh') INSERT INTO AttributeValues (AttributeId, Value) VALUES (@Aid, N'Xanh');
...
IF NOT EXISTS (SELECT 1 FROM ProductVariantAttributeValue WHERE ProductVariantId = @Vid AND ValueId = @Valid) INSERT INTO ProductVariantAttributeValue (ProductVariantId, ValueId) VALUES (@Vid, @Valid);
INSERT INTO ProductVariants (ProductId, SKU, VariantName, Price, CostPrice, StockQuantity, ImageUrl, CreatedDate)
VALUES (@Pid, N'KOZ-PHỤ58-ĐỎ', N'Đỏ', 824249.0, 659399.2000000001, 26, N'https://malossistore.vn/img/p/product_58.jpg', GETDATE());
SET @Vid = SCOPE_IDENTITY();
IF NOT EXISTS (SELECT 1 FROM ProductAttributes WHERE AttributeName = N'Màu sắc') INSERT INTO ProductAttributes (AttributeName) VALUES (N'Màu sắc');
SET @Aid = (SELECT AttributeId FROM ProductAttributes WHERE AttributeName = N'Màu sắc');
IF NOT EXISTS (SELECT 1 FROM AttributeValues WHERE AttributeId = @Aid AND Value = N'Đỏ') INSERT INTO AttributeValues (AttributeId, Value) VALUES (@Aid, N'Đỏ');
...
IF NOT EXISTS (SELECT 1 FROM ProductVariantAttributeValue WHERE ProductVariantId = @Vid AND ValueId = @Valid) INSERT INTO ProductVariantAttributeValue (ProductVariantId, ValueId) VALUES (@Vid, @Valid);
INSERT INTO ProductVariants (ProductId, SKU, VariantName, Price, CostPrice, StockQuantity, ImageUrl, CreatedDate)
VALUES (@Pid, N'KOZ-PHỤ58-BẠC', N'Bạc', 803812.0, 643049.6000000001, 45, N'https://malossistore.vn/img/p/product_58.jpg', GETDATE());
SET @Vid = SCOPE_IDENTITY();
IF NOT EXISTS (SELECT 1 FROM ProductAttributes WHERE AttributeName = N'Màu sắc') INSERT INTO ProductAttributes (AttributeName) VALUES (N'Màu sắc');
SET @Aid = (SELECT AttributeId FROM ProductAttributes WHERE AttributeName = N'Màu sắc');
IF NOT EXISTS (SELECT 1 FROM AttributeValues WHERE AttributeId = @Aid AND Value = N'Bạc') INSERT INTO AttributeValues (AttributeId, Value) VALUES (@Aid, N'Bạc');
...
IF NOT EXISTS (SELECT 1 FROM ProductVariantAttributeValue WHERE ProductVariantId = @Vid AND ValueId = @Valid) INSERT INTO ProductVariantAttributeValue (ProductVariantId, ValueId) VALUES (@Vid, @Valid);
INSERT INTO ProductVariants (ProductId, SKU, VariantName, Price, CostPrice, StockQuantity, ImageUrl, CreatedDate)
VALUES (@Pid, N'KOZ-PHỤ58-ĐEN', N'Đen', 828002.0, 662401.6000000001, 29, N'https://malossistore.vn/img/p/product_58.jpg', GETDATE());
SET @Vid = SCOPE_IDENTITY();
IF NOT EXISTS (SELECT 1 FROM ProductAttributes WHERE AttributeName = N'Màu sắc') INSERT INTO ProductAttributes (AttributeName) VALUES (N'Màu sắc');
SET @Aid = (SELECT AttributeId FROM ProductAttributes WHERE AttributeName = N'Màu sắc');
IF NOT EXISTS (SELECT 1 FROM AttributeValues WHERE AttributeId = @Aid AND Value = N'Đen') INSERT INTO AttributeValues (AttributeId, Value) VALUES (@Aid, N'Đen');
