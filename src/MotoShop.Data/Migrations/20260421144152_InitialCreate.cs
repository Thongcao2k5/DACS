    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MotorbikeModels", x => x.ModelId);
                    table.ForeignKey(
                        name: "FK_MotorbikeModels_MotorbikeModels_ParentId",
                        column: x => x.ParentId,
                        principalTable: "MotorbikeModels",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProductVariants_MotorbikeModels_ModelId",
                        column: x => x.ModelId,
                        principalTable: "MotorbikeModels",
                        principalColumn: "ModelId");
                    table.ForeignKey(
                        ...
                        principalColumn: "ProductId");
                    table.ForeignKey(
                        name: "FK_ProductVariants_Units_BaseUnitId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    OrderId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    OrderCode = table.Column<string>(type: "nvarchar(max)", nullable: true, computedColumnSql: "'DH'+right('000000'+CONVERT([nvarchar],[OrderId]),(6))", stored: true),
                    CustomerId = table.Column<int>(type: "int", nullable: true),
                    StoreId = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    BookingId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    BookingCode = table.Column<string>(type: "nvarchar(max)", nullable: true, computedColumnSql: "'DV'+right('000000'+CONVERT([nvarchar],[BookingId]),(6))", stored: true),
                    CustomerId = table.Column<int>(type: "int", nullable: true),
                    ...
                    DepositStatus = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    TransferProof = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProductVariantAttributeValue_AttributeValues_ValueId",
                        column: x => x.ValueId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MotorbikeModels_ParentId",
                table: "MotorbikeModels",
                column: "ParentId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductVariantAttributeValue_ValueId",
                table: "ProductVariantAttributeValue",
                column: "ValueId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductVariants_ModelId",
                table: "ProductVariants",
                column: "ModelId");
