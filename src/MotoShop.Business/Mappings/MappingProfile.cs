    ...
    public class MappingProfile : Profile
    {
        public MappingProfile()
        {
            ...
            CreateMap<Product, ProductDto>()
                ...
                .ForMember(dest => dest.MinPrice, opt => opt.MapFrom(src => src.Variants != null && src.Variants.Any() ? src.Variants.Min(v => v.Price) : 0))
                .ForMember(dest => dest.MinOriginalPrice, opt => opt.MapFrom(src => src.Variants != null && src.Variants.Any() ? src.Variants.OrderBy(v => v.Price).FirstOrDefault().OriginalPrice : null))
                .ForMember(dest => dest.OldPrice, opt => opt.MapFrom(src => src.Variants != null && src.Variants.Any() ? src.Variants.OrderBy(v => v.Price).FirstOrDefault().OriginalPrice : null))
                .ForMember(dest => dest.DefaultVariantId, opt => opt.MapFrom(src => src.Variants != null && src.Variants.Any() ? src.Variants.FirstOrDefault().ProductVariantId : 0))
