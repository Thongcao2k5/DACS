    ...
    public class MappingProfile : Profile
    {
        public MappingProfile()
        {
            ...
            CreateMap<Product, ProductDto>()
                ...
                .ForMember(dest => dest.OldPrice, opt => opt.MapFrom(src => src.IsFeatured && src.Variants.Any() ? src.Variants.Min(v => v.Price) * 1.2m : 0))
                .ForMember(dest => dest.DiscountPercent, opt => opt.MapFrom(src => src.IsFeatured ? 20 : 0))
